...
Webflow.require('ix').init([
  {"slug":"showhide-filter-groups","name":"Show/hide filter-groups","value":{"style":{},"triggers":[{"type":"click","selector":".group-items","siblings":true,"stepsA":[{"display":"block"}],"stepsB":[{"display":"none"}]}]}},
  {"slug":"display-none","name":"Display none","value":{"style":{"display":"none"},"triggers":[]}},
  {"slug":"showhide-all-filters","name":"Show/hide all filters","value":{"style":{},"triggers":[{"type":"click","selector":".filters","siblings":true,"stepsA":[{"display":"block"}],"stepsB":[{"display":"none"}]}]}}
]);
